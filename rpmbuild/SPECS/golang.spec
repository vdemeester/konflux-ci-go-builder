...
# Patch230:	update-api-openssl3.patch # FIXME: see if we need to re-enable
# Patch231:	evp-digest-sign-final.patch # FIXME: see how to adapt
...
ls -l
find . -name goopenssl.h
cat ./src/vendor/github.com/golang-fips/openssl/v2/goopenssl.h
find . -name hmac.go
cat ./src/vendor/github.com/golang-fips/openssl/v2/hmac.go
grep -r go_openssl_HMAC_Update ./src/vendor/github.com/golang-fips/
